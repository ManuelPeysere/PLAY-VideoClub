...
//     }
// }
const disponibles = [ {id:1, titulo: "1. Animales fantásticos: Los secretos de Dumbledore", duracion: "2h 23m", precio: 5800 },
...
function consulta () {
    ...
    if (consulta == "SI") {
        let pelis = peliculas()
        let numIdPeli  = prompt(pelis + " " + "Indique el número de la pelicula que desea comprar");
